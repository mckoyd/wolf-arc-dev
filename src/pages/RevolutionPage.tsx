    ...
    <Grid container direction={"column"}>
      ...
      >
        ...
        <Grid item lg style={{ alignSelf: "center" }}>
          <img src={ConsultationImg} alt="handshake" />
        </Grid>
      </Grid>
      ...
      >
        ...
        <Grid item lg style={{ alignSelf: "center" }}>
          <img src={MockupImg} alt="basic website design outline" />
        </Grid>
      </Grid>
      ...
      >
        ...
        <Grid item lg style={{ alignSelf: "center" }}>
          <img src={ReviewImg} alt="magnifying glass" />
        </Grid>
      </Grid>
      ...
      >
        ...
        <Grid item lg style={{ alignSelf: "center" }}>
          <img src={DesignImg} alt="paintbrush leaving stroke of paint" />
        </Grid>
      </Grid>
      ...
      >
        ...
        <Grid item lg style={{ alignSelf: "center" }}>
          <img src={BuildImg} alt="building construction site" />
        </Grid>
      </Grid>
      ...
      >
        ...
        <Grid item lg style={{ alignSelf: "center" }}>
          <img src={MaintainImg} alt="wrench tightening bolts" />
        </Grid>
      </Grid>
      ...
      >
        ...
        <Grid item lg style={{ alignSelf: "center" }}>
          <img src={IterateImg} alt="falling dominoes" />
        </Grid>
      </Grid>
      <CallToAction />
    </Grid>
